...
## 🚀 What's New in v6.2.14

### 🔄 Auto-Updater UX
- **Visible download progress** — When an update is downloading, a progress bar appears in the Application Updates card showing real-time percentage, download speed (MB/s), and transferred/total bytes.
- **Clear status states** — UI shows distinct states for checking, downloading, ready-to-install, and error with proper button re-enabling.
