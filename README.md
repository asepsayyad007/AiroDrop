...
![Version](https://img.shields.io/badge/version-6.4.86-orange.svg?style=flat-square)
...
* **[Download Setup Installer (v6.4.86)](https://github.com/asepsayyad007/AiroDrop/releases/download/v6.4.86/AiroDrop.Setup.6.4.86.exe)** — Standard Windows wizard installation.
* **[Download Portable Version (v6.4.86)](https://github.com/asepsayyad007/AiroDrop/releases/download/v6.4.86/AiroDrop-Portable-6.4.86.exe)** — Standalone execution without installation.
