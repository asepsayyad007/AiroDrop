...
![Version](https://img.shields.io/badge/version-6.4.0-orange.svg?style=flat-square)
...
* **[Download Setup Installer (v6.4.0)](https://github.com/asepsayyad007/AiroDrop/releases/download/v6.4.0/AiroDrop.Setup.6.4.0.exe)** — Standard Windows wizard installation.
* **[Download Portable Version (v6.4.0)](https://github.com/asepsayyad007/AiroDrop/releases/download/v6.4.0/AiroDrop-Portable-6.4.0.exe)** — Standalone execution without installation.
